define(['creanvas/Core/serverBus','modules/Vector'], function (serverBus, Vector) {
  ...
  var circular = function (appBus, element) {
    ...
    element.circular.originalRadius = element.circular.originalRadius || element.circular.currentRadius();
    ...
    element.on('moveCommitted', function () {
      element.circular.originalRadius = element.circular.currentRadius();
    });
